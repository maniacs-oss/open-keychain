...
public class OpenPgpServiceKeyIdExtractorTest {
    ...
    private TrustIdentityDataAccessObject trustIdentityDao;

    @Before
    public void setUp() throws Exception {
        contentResolver = mock(ContentResolver.class);
        apiPendingIntentFactory = mock(ApiPendingIntentFactory.class);
        trustIdentityDao = mock(TrustIdentityDataAccessObject.class);
        when(trustIdentityDao.getCallingPackageName()).thenReturn("package_name");
    ...
    public void returnKeyIdsFromIntent__withKeyIdsExtra() throws Exception {
        ...
        KeyIdResult keyIdResult = openPgpServiceKeyIdExtractor.returnKeyIdsFromIntent(intent, false, trustIdentityDao);
    ...
    public void returnKeyIdsFromIntent__withNoData__askIfNoData() throws Exception {
        ...
        KeyIdResult keyIdResult = openPgpServiceKeyIdExtractor.returnKeyIdsFromIntent(intent, true, trustIdentityDao);
