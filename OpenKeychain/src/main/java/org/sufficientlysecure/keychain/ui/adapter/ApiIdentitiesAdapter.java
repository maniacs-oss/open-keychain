...
public class ApiIdentitiesAdapter extends CursorAdapter {
    private static final String[] API_IDENTITIES_PROJECTION = new String[] {
            ApiIdentity._ID,
            ApiIdentity.PACKAGE_NAME,
            ApiIdentity.IDENTIFIER,
    };
    ...
    public ApiIdentitiesAdapter(Context context, Cursor c, int flags) {
    ...
    public static CursorLoader createLoader(Activity activity, Uri dataUri) {
        Uri baseUri = ApiIdentity.buildByKeyUri(dataUri);
        return new CursorLoader(activity, baseUri, ApiIdentitiesAdapter.API_IDENTITIES_PROJECTION, null, null, null);
    }
